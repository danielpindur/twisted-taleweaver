...
namespace TwistedTaleweaver.Integration.Twitch.Helix.Model
{
    ...
    /// </summary>
    public partial class EventSubSubscriptionTransport : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public EventSubSubscriptionTransport(MethodEnum method, Option<string?> callback = default, Option<string?> sessionId = default, Option<DateTime?> connectedAt = default, Option<DateTime?> disconnectedAt = default)
        {
            Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventSubSubscriptionTransport {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="EventSubSubscriptionTransport" />
    /// </summary>
    public class EventSubSubscriptionTransportJsonConverter : JsonConverter<EventSubSubscriptionTransport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EventSubSubscriptionTransport" />
        /// </summary>
        ...
        public override EventSubSubscriptionTransport Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EventSubSubscriptionTransport.MethodEnum?> method = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "method":
                            ...
                            if (methodRawValue != null)
                                method = new Option<EventSubSubscriptionTransport.MethodEnum?>(EventSubSubscriptionTransport.MethodEnumFromStringOrDefault(methodRawValue));
                            break;
                        case "callback":
            ...
            if (!method.IsSet)
                throw new ArgumentException("Property is required for class EventSubSubscriptionTransport.", nameof(method));

            if (method.IsSet && method.Value == null)
                throw new ArgumentNullException(nameof(method), "Property is not nullable for class EventSubSubscriptionTransport.");

            if (callback.IsSet && callback.Value == null)
                throw new ArgumentNullException(nameof(callback), "Property is not nullable for class EventSubSubscriptionTransport.");

            if (sessionId.IsSet && sessionId.Value == null)
                throw new ArgumentNullException(nameof(sessionId), "Property is not nullable for class EventSubSubscriptionTransport.");

            if (connectedAt.IsSet && connectedAt.Value == null)
                throw new ArgumentNullException(nameof(connectedAt), "Property is not nullable for class EventSubSubscriptionTransport.");

            if (disconnectedAt.IsSet && disconnectedAt.Value == null)
                throw new ArgumentNullException(nameof(disconnectedAt), "Property is not nullable for class EventSubSubscriptionTransport.");

            return new EventSubSubscriptionTransport(method.Value!.Value!, callback, sessionId, connectedAt, disconnectedAt);
        }

        /// <summary>
        /// Serializes a <see cref="EventSubSubscriptionTransport" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eventSubSubscriptionTransport"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EventSubSubscriptionTransport eventSubSubscriptionTransport, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, eventSubSubscriptionTransport, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EventSubSubscriptionTransport" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eventSubSubscriptionTransport"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EventSubSubscriptionTransport eventSubSubscriptionTransport, JsonSerializerOptions jsonSerializerOptions)
        {
            if (eventSubSubscriptionTransport.CallbackOption.IsSet && eventSubSubscriptionTransport.Callback == null)
                throw new ArgumentNullException(nameof(eventSubSubscriptionTransport.Callback), "Property is required for class EventSubSubscriptionTransport.");

            if (eventSubSubscriptionTransport.SessionIdOption.IsSet && eventSubSubscriptionTransport.SessionId == null)
                throw new ArgumentNullException(nameof(eventSubSubscriptionTransport.SessionId), "Property is required for class EventSubSubscriptionTransport.");

            var methodRawValue = EventSubSubscriptionTransport.MethodEnumToJsonValue(eventSubSubscriptionTransport.Method);
            writer.WriteString("method", methodRawValue);
            if (eventSubSubscriptionTransport.CallbackOption.IsSet)
                writer.WriteString("callback", eventSubSubscriptionTransport.Callback);

            if (eventSubSubscriptionTransport.SessionIdOption.IsSet)
                writer.WriteString("session_id", eventSubSubscriptionTransport.SessionId);

            if (eventSubSubscriptionTransport.ConnectedAtOption.IsSet)
                writer.WriteString("connected_at", eventSubSubscriptionTransport.ConnectedAtOption.Value!.Value.ToString(ConnectedAtFormat));

            if (eventSubSubscriptionTransport.DisconnectedAtOption.IsSet)
                writer.WriteString("disconnected_at", eventSubSubscriptionTransport.DisconnectedAtOption.Value!.Value.ToString(DisconnectedAtFormat));
        }
    }
}
