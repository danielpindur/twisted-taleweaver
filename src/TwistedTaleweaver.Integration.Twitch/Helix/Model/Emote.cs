...
namespace TwistedTaleweaver.Integration.Twitch.Helix.Model
{
    ...
    /// Emote
    /// </summary>
    public partial class Emote : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="emoteType">The type of emote. The possible values are:       * bitstier — A Bits tier emote. * follower — A follower emote. * subscriptions — A subscriber emote.</param>
        ...
        [JsonConstructor]
        public Emote(string id, string name, ChannelEmoteImages images, EmoteTypeEnum emoteType, string emoteSetId, string ownerId, List<Emote.FormatEnum> format, List<Emote.ScaleEnum> scale, List<Emote.ThemeModeEnum> themeMode)
        {
            Id = id;
            Name = name;
            Images = images;
        ...
        /// </summary>
        /// <value>The type of emote. The possible values are:       * bitstier — A Bits tier emote. * follower — A follower emote. * subscriptions — A subscriber emote.</value>
        ...
        public List<Emote.FormatEnum> Format { get; set; }
        ...
        public List<Emote.ScaleEnum> Scale { get; set; }
        ...
        public List<Emote.ThemeModeEnum> ThemeMode { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Emote" />
    /// </summary>
    public class EmoteJsonConverter : JsonConverter<Emote>
    {
        /// <summary>
        /// Deserializes json to <see cref="Emote" />
        /// </summary>
        ...
        public override Emote Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Emote.EmoteTypeEnum?> emoteType = default;
            Option<string?> emoteSetId = default;
            Option<string?> ownerId = default;
            Option<List<Emote.FormatEnum>?> format = default;
            Option<List<Emote.ScaleEnum>?> scale = default;
            Option<List<Emote.ThemeModeEnum>?> themeMode = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "emote_type":
                            ...
                            if (emoteTypeRawValue != null)
                                emoteType = new Option<Emote.EmoteTypeEnum?>(Emote.EmoteTypeEnumFromStringOrDefault(emoteTypeRawValue));
                            break;
                        case "emote_set_id":
                        ...
                        case "owner_id":
                            ...
                            break;
                        case "format":
                            format = new Option<List<Emote.FormatEnum>?>(JsonSerializer.Deserialize<List<Emote.FormatEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "scale":
                            scale = new Option<List<Emote.ScaleEnum>?>(JsonSerializer.Deserialize<List<Emote.ScaleEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "theme_mode":
                            themeMode = new Option<List<Emote.ThemeModeEnum>?>(JsonSerializer.Deserialize<List<Emote.ThemeModeEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(id));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(name));

            if (!images.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(images));

            if (!emoteType.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(emoteType));

            if (!emoteSetId.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(emoteSetId));

            if (!ownerId.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(ownerId));

            if (!format.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(format));

            if (!scale.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(scale));

            if (!themeMode.IsSet)
                throw new ArgumentException("Property is required for class Emote.", nameof(themeMode));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Emote.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Emote.");

            if (images.IsSet && images.Value == null)
                throw new ArgumentNullException(nameof(images), "Property is not nullable for class Emote.");

            if (emoteType.IsSet && emoteType.Value == null)
                throw new ArgumentNullException(nameof(emoteType), "Property is not nullable for class Emote.");

            if (emoteSetId.IsSet && emoteSetId.Value == null)
                throw new ArgumentNullException(nameof(emoteSetId), "Property is not nullable for class Emote.");

            if (ownerId.IsSet && ownerId.Value == null)
                throw new ArgumentNullException(nameof(ownerId), "Property is not nullable for class Emote.");

            if (format.IsSet && format.Value == null)
                throw new ArgumentNullException(nameof(format), "Property is not nullable for class Emote.");

            if (scale.IsSet && scale.Value == null)
                throw new ArgumentNullException(nameof(scale), "Property is not nullable for class Emote.");

            if (themeMode.IsSet && themeMode.Value == null)
                throw new ArgumentNullException(nameof(themeMode), "Property is not nullable for class Emote.");

            return new Emote(id.Value!, name.Value!, images.Value!, emoteType.Value!.Value!, emoteSetId.Value!, ownerId.Value!, format.Value!, scale.Value!, themeMode.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="Emote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="emote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Emote emote, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, emote, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Emote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="emote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Emote emote, JsonSerializerOptions jsonSerializerOptions)
        {
            if (emote.Id == null)
                throw new ArgumentNullException(nameof(emote.Id), "Property is required for class Emote.");

            if (emote.Name == null)
                throw new ArgumentNullException(nameof(emote.Name), "Property is required for class Emote.");

            if (emote.Images == null)
                throw new ArgumentNullException(nameof(emote.Images), "Property is required for class Emote.");

            if (emote.EmoteSetId == null)
                throw new ArgumentNullException(nameof(emote.EmoteSetId), "Property is required for class Emote.");

            if (emote.OwnerId == null)
                throw new ArgumentNullException(nameof(emote.OwnerId), "Property is required for class Emote.");

            if (emote.Format == null)
                throw new ArgumentNullException(nameof(emote.Format), "Property is required for class Emote.");

            if (emote.Scale == null)
                throw new ArgumentNullException(nameof(emote.Scale), "Property is required for class Emote.");

            if (emote.ThemeMode == null)
                throw new ArgumentNullException(nameof(emote.ThemeMode), "Property is required for class Emote.");

            writer.WriteString("id", emote.Id);

            writer.WriteString("name", emote.Name);

            writer.WritePropertyName("images");
            JsonSerializer.Serialize(writer, emote.Images, jsonSerializerOptions);
            var emoteTypeRawValue = Emote.EmoteTypeEnumToJsonValue(emote.EmoteType);
            writer.WriteString("emote_type", emoteTypeRawValue);
            writer.WriteString("emote_set_id", emote.EmoteSetId);

            writer.WriteString("owner_id", emote.OwnerId);

            writer.WritePropertyName("format");
            JsonSerializer.Serialize(writer, emote.Format, jsonSerializerOptions);
            writer.WritePropertyName("scale");
            JsonSerializer.Serialize(writer, emote.Scale, jsonSerializerOptions);
            writer.WritePropertyName("theme_mode");
            JsonSerializer.Serialize(writer, emote.ThemeMode, jsonSerializerOptions);
        }
    }
}
